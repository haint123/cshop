 ...
 * @author HP
 */
@WebServlet(name = "DetailOrderServlet", urlPatterns = {"/admin/order/detail"})
public class DetailOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Order_detailsDAO or = new Order_detailsDAO();
            ArrayList<Order_details> list = or.layTheoIdor(id);
            request.setAttribute("data", list);
            OrdersDAO a = new OrdersDAO();
            Orders b = a.layTheoId(id);
            request.setAttribute("data1", b);
