<%-- 
    Document   : insert
    Created on : May 13, 2023, 4:00:46 AM
    Author     : HP
--%>
                ...
                <div class="panel-body">
                    <form action="insert" method="post">
                        <div class="form-group">
                          ...
                          <input required="true" type="text" class="form-control" name="fullname" value="">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="role_id" required="true">
                              <option>-- Chọn --</option>
                            <%
                                ArrayList<Role> t = (ArrayList<Role>) request.getAttribute("data");
                                for(Role i:t){
                        ...
                        <div class="form-group">
                          ...
                          <input required="true" type="tel" class="form-control"name="phone_number" value="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control" name="password" minlength="6" value="">
                        </div>
