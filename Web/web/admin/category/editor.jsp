<%-- 
    Document   : editor
    Created on : May 13, 2023, 6:49:56 PM
    Author     : HP
--%>
    ...
    <div class="col-md-6">
        <form action="editor" method="post">
            ...
            <div class="form-group">
                ...
                <input required="true" type="text" class="form-control" id="usr" name="name" value="<%=a.getName()%>">
        ...
        <table class="table table-bordered table-hover" 
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= i.getName()%></td>
                    <th style="width: 50px;">
                        <a href = "?id=<%=i.getId()%>"><button class="btn btn-warning">Sửa</button></a>
                    </th>
                    <th style="width: 50px;">
